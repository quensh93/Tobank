...
class PromissoryTransactionDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PromissoryTransactionDetailPageController>(
      ...
      builder: (controller) {
        controller.setValues(transactionData!, multiSignPath);
        return SizedBox(
                  ...
                  child: Column(
                    children: <Widget>[
                      Column(
                        children: [
                          SvgIcon(
                            controller.transactionData.trStatus ==
                                    locale.success_ENG
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              KeyValueWidget(
                                ...
                                valueString:
                                    controller.transactionData.service ?? '',
                              ),
                              const SizedBox(height: 16.0),
                              MySeparator(color: context.theme.dividerColor),
                              const SizedBox(height: 16.0),
                              ...
                              KeyValueWidget(
                                ...
                                valueString:
                                    controller.transactionData.trTypeFa ?? '',
                              ),
                              const SizedBox(height: 16.0),
                              MySeparator(color: context.theme.dividerColor),
                              const SizedBox(height: 16.0),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            const SvgIcon(SvgIcons.pdfFile, size: 32),
