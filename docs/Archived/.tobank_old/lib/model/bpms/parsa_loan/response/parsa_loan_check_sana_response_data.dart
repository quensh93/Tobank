...
ParsaLoanCheckSanaResponseData parsaLoanCheckSanaResponseDataFromJson(String str) =>
    ParsaLoanCheckSanaResponseData.fromJson(json.decode(str));

String parsaLoanCheckSanaResponseDataToJson(ParsaLoanCheckSanaResponseData data) => json.encode(data.toJson());

class ParsaLoanCheckSanaResponseData {
  String? message;
  bool? success;
  Data? data;

  ParsaLoanCheckSanaResponseData({
    this.message,
    this.success,
    this.data,
  });

  factory ParsaLoanCheckSanaResponseData.fromJson(Map<String, dynamic> json) => ParsaLoanCheckSanaResponseData(
