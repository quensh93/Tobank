...
TrackingInquiryResponse trackingInquiryResponseFromJson(String str) =>
    TrackingInquiryResponse.fromJson(json.decode(str));

String trackingInquiryResponseToJson(TrackingInquiryResponse data) => json.encode(data.toJson());

class TrackingInquiryResponse {
  TrackingInquiryResponse({
    this.chequeId,
    this.serialNo,
    this.fromIban,
    this.amount,
  ...
  factory TrackingInquiryResponse.fromJson(Map<String, dynamic> json) => TrackingInquiryResponse(
