...
class _NumberPickerSelectedItemDecoration extends StatelessWidget {
  ...
  const _NumberPickerSelectedItemDecoration(
      {required this.axis, required this.itemExtent, required this.decoration, super.key});
...
class NumberPickerDialog extends StatefulWidget {
  ...
  @override
  State<NumberPickerDialog> createState() => NumberPickerDialogControllerState();
}

class NumberPickerDialogControllerState extends State<NumberPickerDialog> {
