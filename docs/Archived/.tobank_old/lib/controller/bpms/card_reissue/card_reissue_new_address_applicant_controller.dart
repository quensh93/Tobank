...
import '../../../model/bpms/card/card_reissuance/request/complete_get_new_address_from_applicant_task_data.dart';
...
class CardReissueNewAddressApplicantController extends GetxController {
  final Task task;
  ...
  CardReissueNewAddressApplicantController({required this.task, required this.taskData});
...
//locale
  ...
  /// Validates customer address information
  /// and completes the location update request if all fields are valid.
