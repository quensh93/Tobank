...
import '../../../model/bpms/card/card_physical_issuance/request/complete_get_new_address_from_applicant_task_data.dart';
...
class CardPhysicalIssueNewAddressApplicantController extends GetxController {
  final Task task;
  ...
  CardPhysicalIssueNewAddressApplicantController({required this.task, required this.taskData});
...
//locale
    final locale = AppLocalizations.of(Get.context!)!;
    final CompleteTaskRequest<CompleteGetNewAddressFromApplicantTaskData> completeTaskRequest = CompleteTaskRequest(
      customerNumber: mainController.authInfoData!.customerNumber!,
      nationalId: mainController.authInfoData!.nationalCode!,
      personalityType: 0,
      trackingNumber: const Uuid().v4(),
      taskId: task.id!,
      taskData: CompleteGetNewAddressFromApplicantTaskData(
