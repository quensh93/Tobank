...
import '../../../model/bpms/military_guarantee/request/complete_customer_additional_documents_task_data.dart';
...
class MillitaryGuaranteeCustomerAdditionalDocumentController extends GetxController {
  final Task task;
  ...
  MillitaryGuaranteeCustomerAdditionalDocumentController({required this.task, required this.taskData}) {
    _handleAdditionalDocuments();
  }

  /// Handles additional documents for a task, categorizing them based on status.
