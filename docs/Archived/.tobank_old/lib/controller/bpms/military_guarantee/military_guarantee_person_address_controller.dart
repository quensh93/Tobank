...
import '../../../model/bpms/military_guarantee/request/complete_customer_location_task_data.dart';
...
class MilitaryGuaranteePersonAddressController extends GetxController {
  final Task task;
  ...
  bool isShowCustomerOwnershipList = false;
  ...
  MilitaryGuaranteePersonAddressController({required this.task, required this.taskData});

  void toggleShowCustomerOwnership() {
    isShowCustomerOwnershipList = !isShowCustomerOwnershipList;
    update();
  }

  void setCustomerOwnershipData(BPMSOwnershipData ownershipData) {
    selectedCustomerOwnershipData = ownershipData;
    isShowCustomerOwnershipList = false;
    update();
  }
...
//locale
  ...
  /// Validates customer address information, check for valid ownership data, tracking code, and uploaded document.
...
//locale
  ...
  /// Completes the customer location request by sending data to the backend.
    ...
    final CompleteTaskRequest completeTaskRequest = CompleteTaskRequest(
      ...
      taskData: CompleteCustomerLocationTaskData(
        ...
        applicantResidencyDocument: DocumentFile(
          value:
              DocumentFileValue(id: _documentFileUUID_1, status: null, title: 'residencyDocument', description: null),
        ),
      ),
    );
