...
import '../../../model/bpms/military_guarantee/request/complete_employment_others_task_data.dart';
...
class MilitaryGuaranteeOtherEmploymentController extends GetxController {
  final Task task;
  ...
  MilitaryGuaranteeOtherEmploymentController({required this.task, required this.taskData}) {
  ...
  void _getDataFromTaskData() {
    for (final formField in taskData) {
      if (formField.value?.subValue != null) {
        switch (formField.id) {
          case 'applicantaffidavitDocument':
  ...
  void validateOtherEmploymentPage() {
//locale
    ...
    if (_documentFileUUID_1 != null) {
      ...
      SnackBarUtil.showInfoSnackBar(
        locale.select_your_employment_documents,
      );
    }
  }
...
//locale
    ...
    final CompleteTaskRequest completeTaskRequest = CompleteTaskRequest(
      ...
      taskData: CompleteEmploymentOthersTaskData(
        applicantaffidavitDocument: DocumentFile(
          value: DocumentFileValue(
            id: _documentFileUUID_1,
            status: null,
            title: 'AffidavitDocument',
            description: null,
          ),
        ),
      ),
