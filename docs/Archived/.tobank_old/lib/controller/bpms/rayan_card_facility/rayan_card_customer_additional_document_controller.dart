...
import '../../../model/bpms/rayan_card_facility/request/complete_customer_additional_documents_task_data.dart';
...
class RayanCardCustomerAdditionalDocumentController extends GetxController {
  final Task task;
  ...
  RayanCardCustomerAdditionalDocumentController({required this.task, required this.taskData}) {
    _handleAdditionalDocuments();
  }

  /// Handles additional documents by categorizing them based on their status.
  ...
  /// Selects a document image from either the camera or gallery, crops it, and initiates an upload request.
...
//locale
    ...
    final CompleteTaskRequest completeTaskRequest = CompleteTaskRequest(
      ...
      taskId: task.id!,
      taskData: CompleteCustomerApplicantAdditionalDocumentsTaskData(
