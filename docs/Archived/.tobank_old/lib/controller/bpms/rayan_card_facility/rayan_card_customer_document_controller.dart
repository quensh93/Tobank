...
import '../../../model/bpms/rayan_card_facility/request/complete_customer_documents_task_data.dart';
...
class RayanCardCustomerDocumentController extends GetxController {
  final Task task;
  ...
  RayanCardCustomerDocumentController({required this.task, required this.taskData});
