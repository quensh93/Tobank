...
import '../../../model/bpms/credit_card_facility/request/complete_guarantor_acceptance_task_data.dart';
...
class CreditCardGuaranteeConfirmController extends GetxController {
  final Task task;
  ...
  CreditCardGuaranteeConfirmController({required this.task, required this.taskData});
  ...
  /// Retrieves the details of a process instance using the BPMSServices.
