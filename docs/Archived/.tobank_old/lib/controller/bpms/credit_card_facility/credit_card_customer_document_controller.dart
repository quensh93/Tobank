...
import '../../../model/bpms/credit_card_facility/request/complete_customer_documents_task_data.dart';
...
class CreditCardCustomerDocumentController extends GetxController {
  final Task task;
  ...
  CreditCardCustomerDocumentController({required this.task, required this.taskData});
...
//locale
  ...
  /// to the backend with the uploaded document IDs
