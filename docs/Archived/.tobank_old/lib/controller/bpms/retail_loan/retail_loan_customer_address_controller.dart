...
import '../../../model/bpms/retail_loan/request/complete_customer_location_task_data.dart';
...
class RetailLoanCustomerAddressController extends GetxController {
  final Task task;
  ...
  RetailLoanCustomerAddressController({required this.task, required this.taskData});
...
//locale
  ...
  void _completeCustomerLocationRequest() { //locale
    final locale = AppLocalizations.of(Get.context!)!;
    isLoading = true;
    update();
