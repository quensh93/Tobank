...
import '../../../model/bpms/retail_loan/request/complete_customer_collateral_info_task_data.dart';
...
class RetailLoanAddWarrantyController extends GetxController {
  final Task task;
  ...
  RetailLoanAddWarrantyController({required this.task, required this.taskData}) {
...
//locale
    ...
    if (collateralPromissoryPublishResultData != null) {
      ...
      SnackBarUtil.showInfoSnackBar(
        locale.select_electronic_promissory,
      );
    }
  }
...
//locale
    ...
    final CompleteTaskRequest completeTaskRequest = CompleteTaskRequest(
      ...
      taskId: task.id!,
      taskData: TaskDataCustomerCollateralInfo(
