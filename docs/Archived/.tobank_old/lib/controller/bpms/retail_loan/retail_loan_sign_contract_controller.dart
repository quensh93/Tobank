...
import '../../../model/bpms/retail_loan/request/complete_sign_contract_task_data.dart';
...
class RetailLoanSignContractController extends GetxController {
  final Task task;
  ...
  RetailLoanSignContractController({required this.task, required this.taskData}) {
