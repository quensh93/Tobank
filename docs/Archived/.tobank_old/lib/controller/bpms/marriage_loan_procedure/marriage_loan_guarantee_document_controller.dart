...
import '../../../model/bpms/marriage_loan/request/complete_guarantor_documents_task_data.dart';
...
class MarriageLoanProcedureGuaranteeDocumentController extends GetxController {
  final Task task;
  ...
  MarriageLoanProcedureGuaranteeDocumentController({required this.task, required this.taskData});
...
//locale
  ...
  /// Completes the guarantor documents request by sending a request
