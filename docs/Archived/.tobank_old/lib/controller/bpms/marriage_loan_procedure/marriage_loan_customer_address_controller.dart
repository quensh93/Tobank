...
import '../../../model/bpms/marriage_loan/request/complete_customer_location_task_data.dart';
...
class MarriageLoanProcedureCustomerAddressController extends GetxController {
  final Task task;
  ...
  MarriageLoanProcedureCustomerAddressController({required this.task, required this.taskData});
  ...
  /// Validates the customer's postal code
  /// and, if valid, initiates a customer address inquiry request.
...
//locale
  ...
  /// Sends a request to inquire about the customer's address based on the provided postal code.
...
//locale
  ...
  /// Validates the customer's address information
  /// and if valid, proceeds to complete the edit customer location request.
...
//locale
  ...
  /// Completes the edit customer location request by sending a request
