...
import '../../../model/bpms/marriage_loan/request/complete_customer_additional_documents_task_data.dart';
...
class MarriageLoanProcedureCustomerAdditionalDocumentController extends GetxController {
  final Task task;
  ...
  MarriageLoanProcedureCustomerAdditionalDocumentController({required this.task, required this.taskData}) {
    _handleAdditionalDocuments();
  }

  /// Handles additional documents by categorizing them into approved, rejected,
  /// and pending upload based on their status.
