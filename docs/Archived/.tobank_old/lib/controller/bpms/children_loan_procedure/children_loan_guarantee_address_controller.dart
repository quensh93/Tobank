...
import '../../../model/bpms/children_loan/request/complete_guarantor_location_task_data.dart';
...
class ChildrenLoanProcedureGuaranteeAddressController extends GetxController {
  final Task task;
  ...
  ChildrenLoanProcedureGuaranteeAddressController({required this.task, required this.taskData});
...
//locale
  ...
  /// Retrieves address information for a guarantee or surety based on a postal code.
...
//locale
  ...
  /// Completes the process of editing a guarantor's location and residency information.
  ///
  /// This function submits updated guarantor address, residency type, tracking code, description, and document information to complete a task.
