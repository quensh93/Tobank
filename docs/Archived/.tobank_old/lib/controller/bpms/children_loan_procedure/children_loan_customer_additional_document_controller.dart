...
import '../../../model/bpms/children_loan/request/complete_customer_additional_documents_task_data.dart';
...
class ChildrenLoanProcedureCustomerAdditionalDocumentController extends GetxController {
  final Task task;
  ...
  ChildrenLoanProcedureCustomerAdditionalDocumentController({required this.task, required this.taskData}) {
...
//locale
  ...
  ///
  /// This function prepares and submits customer documents to complete a task,
...
//locale
    ...
    final CompleteTaskRequest completeTaskRequest = CompleteTaskRequest(
      ...
      taskId: task.id!,
      taskData: CompleteApplicantAdditionalDocumentsTaskData(
