...
import '../../../model/bpms/children_loan/request/complete_customer_documents_task_data.dart';
...
class ChildrenLoanProcedureCustomerDocumentController extends GetxController {
  final Task task;
  ...
  bool applicantIsFathersChild = true;

  ChildrenLoanProcedureCustomerDocumentController({required this.task, required this.taskData});

  void radioOnChanged(bool? value) {
    applicantIsFathersChild = value!;
    update();
  }

  void setApplicantIsFathersChild() {
    applicantIsFathersChild = true;
    update();
  }

  void setApplicantIsGuardianChild() {
    applicantIsFathersChild = false;
    update();
  }

  void setApplicantIsNotFathersChild(bool value) {
    applicantIsFathersChild = value;
...
//locale
  ...
  /// Completes a task by submitting customer documents.
  void _completeCustomerDocumentsRequest() { //locale
    ...
    final CompleteTaskRequest completeTaskRequest = CompleteTaskRequest(
      ...
      taskData: CompleteCustomerDocumentsTaskData(
        ...
        applicantGuardianshipDocument: _documentFileUUID_4 != null
            ? DocumentFile(
                value: DocumentFileValue(
            ...
            : null,
        applicantIsFathersChild: applicantIsFathersChild,
      ),
    );
