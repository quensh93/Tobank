...
import '../../../model/bpms/children_loan/request/complete_guarantor_info_task_data.dart';
...
class ChildrenLoanProcedureAddGuaranteeController extends GetxController {
  final Task task;
  ...
  ChildrenLoanProcedureAddGuaranteeController({required this.task, required this.taskData});
...
//locale
  ...
  /// either proceeding with the guarantee completion or displaying an error.
...
//locale
  ...
  /// Completes a guarantor information task in a workflow.
  ///
  /// For CBS errors, it shows a specific alert.
  /// Other errors trigger a generic error message.
