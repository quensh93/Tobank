...
import '../../ui/destination_notebook/deposit_notebook/widget/update_iban_notebook_bottom_sheet.dart';
...
class IbanNotebookController extends GetxController {
  ...
  void getDepositNotebookRequest() {
//locale
  ...
  void _showUpdateDepositNotebookBottomSheet() {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Padding(
        ...
        child: const UpdateIbanNotebookBottomSheet(),
      ),
    );
  }
...
//locale
  ...
  /// Sends a request to delete a user's deposit from their notebook.
