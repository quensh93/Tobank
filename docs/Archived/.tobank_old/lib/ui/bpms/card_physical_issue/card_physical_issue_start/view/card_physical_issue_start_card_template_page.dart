...
import '../widget/card_color_item_widget.dart';

class CardPhysicalIssueStartCardTemplatePage extends StatelessWidget {
...
//locale
    final locale = AppLocalizations.of(context)!;    return GetBuilder<CardPhysicalIssueStartController>(
      builder: (controller) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ContinueButtonWidget(
                callback: () {
                  controller.checkZaerCard();
                },
                isLoading: controller.isLoading,
                buttonTitle:locale.instant_card_request
              ),
            ],
          ),
        );
