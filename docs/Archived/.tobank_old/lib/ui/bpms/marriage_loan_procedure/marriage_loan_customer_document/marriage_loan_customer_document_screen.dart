...
import '../../../../../controller/bpms/marriage_loan_procedure/marriage_loan_customer_document_controller.dart';
...
class MarriageLoanProcedureCustomerDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const MarriageLoanProcedureCustomerDocumentScreen({required this.task, required this.taskData, super.key});
...
//locale
    ...
    return GetBuilder<MarriageLoanProcedureCustomerDocumentController>(
      init: MarriageLoanProcedureCustomerDocumentController(task: task, taskData: taskData),
      builder: (controller) {
