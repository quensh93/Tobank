...
import '../../../../../controller/bpms/marriage_loan_procedure/marriage_loan_guarantee_document_controller.dart';
...
class MarriageLoanProcedureGuaranteeDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const MarriageLoanProcedureGuaranteeDocumentScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<MarriageLoanProcedureGuaranteeDocumentController>(
      init: MarriageLoanProcedureGuaranteeDocumentController(task: task, taskData: taskData),
      builder: (controller) {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                locale.upload_id_image_message,
                                style: TextStyle(
