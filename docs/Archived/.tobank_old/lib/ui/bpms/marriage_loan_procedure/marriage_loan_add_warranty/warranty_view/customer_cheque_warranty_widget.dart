...
class CustomerChequeWarrantyWidget extends StatelessWidget {
  const CustomerChequeWarrantyWidget({required this.pageIndex, super.key});
    ...
    return GetBuilder<MarriageLoanProcedureAddWarrantyController>(builder: (controller) {
      return Column(
        ...
        children: [
          ...
          Text(locale.cheque_id_title, style: ThemeUtil.titleStyle),
          const SizedBox(
            height: 8.0,
          ),
          TextField(
          ...
          DocumentPickerWidget(
            title: locale.cheque_image_upload_title,
            subTitle: '',
