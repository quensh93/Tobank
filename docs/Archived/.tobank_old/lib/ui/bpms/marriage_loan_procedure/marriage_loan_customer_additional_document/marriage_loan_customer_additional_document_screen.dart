...
import '../../../../../controller/bpms/marriage_loan_procedure/marriage_loan_customer_additional_document_controller.dart';
...
class MarriageLoanProcedureCustomerAdditionalDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const MarriageLoanProcedureCustomerAdditionalDocumentScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
//locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<MarriageLoanProcedureCustomerAdditionalDocumentController>(
      init: MarriageLoanProcedureCustomerAdditionalDocumentController(task: task, taskData: taskData),
      builder: (controller) {
