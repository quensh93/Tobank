...
class ChildrenLoanWarrantyPage extends StatelessWidget {
  const ChildrenLoanWarrantyPage({
  ...
  String getTitle(ChildrenLoanProcedureAddWarrantyController controller) {
//locale
    ...
    if (pageIndex == 0) {
      ...
      tempTitle += '${locale.guarantee_with_customer_number}${AppUtil.getPersianNumbers(controller.collaterals[pageIndex].customerNumber)}';
    }
    return tempTitle;
  }
