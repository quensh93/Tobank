...
import '../../../../../controller/bpms/children_loan_procedure/children_loan_customer_address_controller.dart';
...
class ChildrenLoanProcedureCustomerAddressScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const ChildrenLoanProcedureCustomerAddressScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<ChildrenLoanProcedureCustomerAddressController>(
      init: ChildrenLoanProcedureCustomerAddressController(task: task, taskData: taskData),
      builder: (controller) {
                                              ...
                                              children: <Widget>[
                                                TextField(
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    suffixIcon: TextFieldClearIconWidget(
                                                      isVisible:
                                                          controller.customerLastStreetController.text.isNotEmpty,
                                                      clearFunction: () {
