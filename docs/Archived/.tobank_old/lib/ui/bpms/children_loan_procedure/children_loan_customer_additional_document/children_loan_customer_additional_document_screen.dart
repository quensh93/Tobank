...
import '../../../../../controller/bpms/children_loan_procedure/children_loan_customer_additional_document_controller.dart';
...
class ChildrenLoanProcedureCustomerAdditionalDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const ChildrenLoanProcedureCustomerAdditionalDocumentScreen({required this.task, required this.taskData, super.key});
...
//locale
    ...
    return GetBuilder<ChildrenLoanProcedureCustomerAdditionalDocumentController>(
      init: ChildrenLoanProcedureCustomerAdditionalDocumentController(task: task, taskData: taskData),
      builder: (controller) {
