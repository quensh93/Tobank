...
import '../../../../../controller/bpms/children_loan_procedure/children_loan_guarantee_document_controller.dart';
...
class ChildrenLoanProcedureGuaranteeDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const ChildrenLoanProcedureGuaranteeDocumentScreen({required this.task, required this.taskData, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ChildrenLoanProcedureGuaranteeDocumentController>(
      init: ChildrenLoanProcedureGuaranteeDocumentController(task: task, taskData: taskData),
      builder: (controller) {
                      ...
                      child: SingleChildScrollView(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(locale.upload_guarantee_identity_documents, style: ThemeUtil.titleStyle),
                              const SizedBox(
                                height: 16.0,
                              ),
                              Text(locale.upload_id_image_message,
                              ...
                              DocumentPickerWidget(
                                title: locale.page_children_certificate_garantee,
                                subTitle: '',
                                cameraFunction: (documentId) {
                                  controller.selectDocumentImage(
                                      documentId: documentId, imageSource: ImageSource.camera);
                              ...
                              DocumentPickerWidget(
                                title: locale.page_life_certificate_garantee,
                                subTitle: '',
                                cameraFunction: (documentId) {
                                  controller.selectDocumentImage(
                                      documentId: documentId, imageSource: ImageSource.camera);
                              ...
                              Text(locale.upload_professional_certificate, style: ThemeUtil.titleStyle),
                              const SizedBox(
                                height: 16.0,
                              ),
                              Text(
                              ...
                              ContinueButtonWidget(
                                callback: () {
                                  controller.validateGuaranteeDocuments();
                                },
