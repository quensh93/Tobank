...
import '../../../../../controller/bpms/children_loan_procedure/children_loan_guarantee_address_controller.dart';
...
class ChildrenLoanProcedureGuaranteeAddressScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const ChildrenLoanProcedureGuaranteeAddressScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<ChildrenLoanProcedureGuaranteeAddressController>(
      init: ChildrenLoanProcedureGuaranteeAddressController(task: task, taskData: taskData),
      builder: (controller) {
