...
import '../../../../../controller/bpms/children_loan_procedure/children_loan_add_guarantee_controller.dart';
...
class ChildrenLoanProcedureAddGuaranteeScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const ChildrenLoanProcedureAddGuaranteeScreen({required this.task, required this.taskData, super.key});
...
//locale
    ...
    return GetBuilder<ChildrenLoanProcedureAddGuaranteeController>(
      init: ChildrenLoanProcedureAddGuaranteeController(task: task, taskData: taskData),
      builder: (controller) {
                      ...
                      child: SingleChildScrollView(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(locale.guarantee_info_title, style: ThemeUtil.titleStyle),
                              const SizedBox(
                                height: 16.0,
                              ),
                              Text(locale.guarantee_mobile_title, style: ThemeUtil.titleStyle),
                              const SizedBox(
                                height: 8.0,
                              ),
                              TextField(
                              ...
                              Text(locale.guarantee_birthday_title, style: ThemeUtil.titleStyle),
                              const SizedBox(
                                height: 8.0,
                              ),
                              Row(
                              ...
                              Text(locale.guarantee_national_code_title, style: ThemeUtil.titleStyle),
                              const SizedBox(
                                height: 8.0,
                              ),
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  errorText: controller.isNationalCodeGuaranteeValid ? null : locale.enter_national_code_error,
                                  border: const OutlineInputBorder(
                                    borderSide: BorderSide.none,
                                    borderRadius: BorderRadius.all(
                                      Radius.circular(10.0),
