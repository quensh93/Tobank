...
class MilitaryGuaranteeOtherEmploymentPage extends StatelessWidget {
  const MilitaryGuaranteeOtherEmploymentPage({
    super.key,
  });
          ...
          child: Column(
            ...
            children: [
              ...
              DocumentPickerWidget(
                title: locale.image_certificate_or_student_document,
                subTitle: '',
              ...
              ContinueButtonWidget(
                callback: () {
                  controller.validateOtherEmploymentPage();
                },
