...
class MilitaryGuaranteeSendLGLocationPage extends StatelessWidget {
  const MilitaryGuaranteeSendLGLocationPage({
    super.key,
  });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  locale.warrenty_post_code_info,
                  style: ThemeUtil.titleStyle,
                ),
                const SizedBox(
                  height: 8.0,
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          errorText: controller.isProvinceValid ? null : locale.inquire_about_postal_code,
                          border: const OutlineInputBorder(
                            borderSide: BorderSide.none,
                            borderRadius: BorderRadius.all(
                              Radius.circular(10.0),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          errorText: controller.isTownshipValid ? null : locale.please_enter_county_value,
                          border: const OutlineInputBorder(
                            borderSide: BorderSide.none,
                            borderRadius: BorderRadius.all(
                              Radius.circular(10.0),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          errorText:
                              controller.isSecondLastStreetValid ? null :locale.secondary_street_error,
                          border: const OutlineInputBorder(
                            borderSide: BorderSide.none,
                            borderRadius: BorderRadius.all(
                              Radius.circular(10.0),
                      ...
                      ContinueButtonWidget(
                        callback: () {
                          controller.validateAddressPage();
                        },
                        isLoading: controller.isLoading,
                        buttonTitle: locale.registration_date_request,
                      ),
                    ],
                  )
                else
