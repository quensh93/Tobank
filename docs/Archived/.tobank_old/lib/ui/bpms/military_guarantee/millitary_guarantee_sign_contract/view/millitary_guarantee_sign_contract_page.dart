...
class MillitaryGuaranteeSignContractPage extends StatelessWidget {
      ...
      builder: (controller) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                locale.contract_acceptance_warranty,
              ...
              ContractWidget(
                rejectReason: null,
                pdfData: base64Decode(controller.unsignedContractBase64!),
                previewFunction: () => controller.showContractPreviewScreen(),
                shareFunction: () => controller.shareContractPdf(),
              ),
              Expanded(child: Container()),
              ContinueButtonWidget(
                callback: () {
                  controller.signContractDocument();
                },
