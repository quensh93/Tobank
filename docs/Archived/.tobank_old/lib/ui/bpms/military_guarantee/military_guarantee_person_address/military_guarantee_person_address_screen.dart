...
class MilitaryGuaranteePersonAddressScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const MilitaryGuaranteePersonAddressScreen({required this.task, required this.taskData, super.key});
...
//locale
    ...
    return GetBuilder<MilitaryGuaranteePersonAddressController>(
      init: MilitaryGuaranteePersonAddressController(task: task, taskData: taskData),
      builder: (controller) {
                  ...
                  children: [
                    Expanded(
                      child: PageView(
                        ...
                        children: const [
                          MilitaryGuaranteePersonAddressPage(),
                        ],
                      ),
                    ),
                  ],
