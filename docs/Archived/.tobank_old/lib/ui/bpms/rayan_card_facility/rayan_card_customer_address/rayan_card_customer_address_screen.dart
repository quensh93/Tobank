...
import '../../../../../controller/bpms/rayan_card_facility/rayan_card_customer_address_controller.dart';
...
class RayanCardCustomerAddressScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const RayanCardCustomerAddressScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<RayanCardCustomerAddressController>(
      init: RayanCardCustomerAddressController(task: task, taskData: taskData),
      builder: (controller) {
                                          ...
                                          children: [
                                            ...
                                            if (controller.selectedCustomerOwnershipData != null &&
                                              ...
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.stretch,
                                                children: [
                                                  Text(locale.hint_text_property_document,
                                                      style: ThemeUtil.titleStyle),
