...
import '../../../../../controller/bpms/rayan_card_facility/rayan_card_customer_document_controller.dart';
...
class RayanCardCustomerDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const RayanCardCustomerDocumentScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
//locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<RayanCardCustomerDocumentController>(
      init: RayanCardCustomerDocumentController(task: task, taskData: taskData),
      builder: (controller) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DocumentPickerWidget(
                                title: locale.second_page_marriage_certificate,
                                subTitle: '',
