...
import '../../../../../controller/bpms/credit_card_facility/credit_card_guarantee_document_controller.dart';
...
class CreditCardGuaranteeDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const CreditCardGuaranteeDocumentScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<CreditCardGuaranteeDocumentController>(
      init: CreditCardGuaranteeDocumentController(task: task, taskData: taskData),
      builder: (controller) {
                      ...
                      child: SingleChildScrollView(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                locale.upload_guarantee_identity_documents,
                              ...
                              Text(
                                locale.upload_all_pages_of_guarantor_birth_certificate_and_employment_document,
                                style: TextStyle(
