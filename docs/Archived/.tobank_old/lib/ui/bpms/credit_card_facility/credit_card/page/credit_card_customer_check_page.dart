...
class CreditCardCustomerCheckPage extends StatelessWidget {
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButtonFormField2(
                      ...
                      hint: Text(
                        locale.enter_credit_card_amount,
                        style: TextStyle(
                          color: ThemeUtil.textSubtitleColor,
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                      ...
                      onChanged: (EnumValue? newValue) {
                        controller.setSelectedCreditCardAmountData(newValue);
                      },
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButtonFormField2(
                      ...
                      value: controller.selectedCreditCardPaymentCountData,
                      hint: Text(
                        locale.select_payment_term,
                        style: TextStyle(
                          color: ThemeUtil.textSubtitleColor,
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                      ...
                      items: controller.creditCardPaymentCountDataList.map((EnumValue item) {
                        return DropdownMenuItem(
                          value: item,
                          alignment: Alignment.centerRight,
                          child: Text(
                      ...
                      onChanged: (EnumValue? newValue) {
                        controller.setSelectedCreditCardPaymentCountData(newValue);
                      },
                    ),
                  ),
                ),
                TextFieldErrorWidget(
                  isValid: controller.isCreditCardPaymentCountValid,
                  errorText: locale.select_payment_term_error,
                ),
                const SizedBox(
                  height: 40.0,
                ),
