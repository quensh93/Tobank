...
import '../../../../../controller/bpms/credit_card_facility/credit_card_add_guarantee_controller.dart';
...
class CreditCardAddGuaranteeScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const CreditCardAddGuaranteeScreen({required this.task, required this.taskData, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CreditCardAddGuaranteeController>(
      init: CreditCardAddGuaranteeController(task: task, taskData: taskData),
      builder: (controller) {
