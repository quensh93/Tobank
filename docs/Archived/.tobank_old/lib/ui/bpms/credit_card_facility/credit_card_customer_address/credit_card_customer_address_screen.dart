...
import '../../../../../controller/bpms/credit_card_facility/credit_card_customer_address_controller.dart';
...
class CreditCardCustomerAddressScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const CreditCardCustomerAddressScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<CreditCardCustomerAddressController>(
      init: CreditCardCustomerAddressController(task: task, taskData: taskData),
      builder: (controller) {
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              locale.applicant_residential_address,
                                              style: ThemeUtil.titleStyle,
                                            ),
                                            const SizedBox(
                                              height: 8.0,
