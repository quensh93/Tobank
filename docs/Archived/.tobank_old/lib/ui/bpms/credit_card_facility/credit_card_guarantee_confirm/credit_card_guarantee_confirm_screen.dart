...
import 'view/credit_card_guarantee_confirm_page.dart';

class CreditCardGuaranteePanelScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const CreditCardGuaranteePanelScreen({required this.task, required this.taskData, super.key});
  ...
  Widget build(BuildContext context) {//locale
    ...
    return GetBuilder<CreditCardGuaranteeConfirmController>(
      init: CreditCardGuaranteeConfirmController(task: task, taskData: taskData),
      builder: (controller) {
                    ...
                    Expanded(
                      child: PageView(
                        ...
                        children: [
                          ...
                          const CreditCardGuaranteeConfirmPage(),
                        ],
                      ),
                    ),
                  ],
