...
import '../../../../../controller/bpms/credit_card_facility/credit_card_customer_additional_document_controller.dart';
...
class CreditCardCustomerAdditionalDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const CreditCardCustomerAdditionalDocumentScreen({required this.task, required this.taskData, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CreditCardCustomerAdditionalDocumentController>(
      init: CreditCardCustomerAdditionalDocumentController(task: task, taskData: taskData),
      builder: (controller) {
