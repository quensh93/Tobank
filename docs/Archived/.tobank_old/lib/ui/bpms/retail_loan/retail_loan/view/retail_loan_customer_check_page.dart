...
class RetailLoanCustomerCheckPage extends StatelessWidget {
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButtonFormField2(
                      ...
                      hint: Text(
                       locale.select_small_loan_amount,
                        style: TextStyle(
                          color: ThemeUtil.textSubtitleColor,
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                      ...
                      onChanged: (EnumValue? newValue) {
                        controller.setSelectedAmountData(newValue);
                      },
                    ),
                  ),
                ),
