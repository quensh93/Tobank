...
import '../../../../../controller/bpms/retail_loan/retail_loan_customer_document_controller.dart';
...
class RetailLoanCustomerDocumentScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const RetailLoanCustomerDocumentScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
//locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<RetailLoanCustomerDocumentController>(
      init: RetailLoanCustomerDocumentController(task: task, taskData: taskData),
      builder: (controller) {
