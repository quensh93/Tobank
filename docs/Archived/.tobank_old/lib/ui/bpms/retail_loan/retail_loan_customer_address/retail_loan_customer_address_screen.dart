...
import '../../../../../controller/bpms/retail_loan/retail_loan_customer_address_controller.dart';
...
class RetailLoanCustomerAddressScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const RetailLoanCustomerAddressScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<RetailLoanCustomerAddressController>(
      init: RetailLoanCustomerAddressController(task: task, taskData: taskData),
      builder: (controller) {
                                      ...
                                      children: [
                                          ...
                                          child: Row(
                                            children: [
                                              Padding(
                                                ...
                                                child: Text(
                                                  controller.getCustomerProvince(),
                                                  textAlign: TextAlign.right,
                                                  style: TextStyle(
                                        ...
                                        if (controller.isOtherOwnershipSelected())
                                          Column(
                                            crossAxisAlignment: CrossAxisAlignment.stretch,
                                            children: [
                                              Text(locale.ownership_description, style: ThemeUtil.titleStyle),
                                              const SizedBox(
                                                height: 8.0,
                                              ),
                                              TextField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  suffixIcon: TextFieldClearIconWidget(
                                                    isVisible:
                                                        controller.descriptionOwnershipController.text.isNotEmpty,
                                                    clearFunction: () {
                                        ...
                                        if (controller.selectedCustomerOwnershipData != null &&
                                          ...
                                          Column(
                                            crossAxisAlignment: CrossAxisAlignment.stretch,
                                            children: [
                                              Text(locale.hint_text_property_document, style: ThemeUtil.titleStyle),
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  suffixIcon: TextFieldClearIconWidget(
                                                    isVisible: controller
                                                        .trackingCodeCustomerOwnershipController.text.isNotEmpty,
                                                    clearFunction: () {
