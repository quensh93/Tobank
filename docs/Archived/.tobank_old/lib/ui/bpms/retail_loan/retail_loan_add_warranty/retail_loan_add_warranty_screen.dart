...
import '../../../../../controller/bpms/retail_loan/retail_loan_add_warranty_controller.dart';
...
class RetailLoanAddWarrantyScreen extends StatelessWidget {
  final Task task;
  final List<TaskDataFormField> taskData;

  const RetailLoanAddWarrantyScreen({required this.task, required this.taskData, super.key});

  @override
  Widget build(BuildContext context) {//locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<RetailLoanAddWarrantyController>(
      init: RetailLoanAddWarrantyController(task: task, taskData: taskData),
      builder: (controller) {
