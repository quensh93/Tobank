...
class OpenDepositRulePage extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child:
                            Text('${locale.non_attendance_deposit_opening_rules} ${controller.selectedDepositType.localName!}',
                                style: TextStyle(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Flexible(
                        child: Text(
                         locale.deposit_terms_and_conditions_acceptance(controller.selectedDepositType.localName!),
                          style: TextStyle(
                            color: ThemeUtil.textTitleColor,
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
              ...
              ContinueButtonWidget(
                ...
                buttonTitle: locale.deposit_button_opening,
