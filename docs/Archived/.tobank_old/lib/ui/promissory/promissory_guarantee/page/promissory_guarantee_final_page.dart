...
class PromissoryGuaranteeFinalPage extends StatelessWidget {
...
//locale
    ...
    return GetBuilder<PromissoryGuaranteeController>(builder: (controller) {
      return SizedBox(
            ...
            child: Column(
              children: <Widget>[
                ...
                const SizedBox(height: 8.0),
                 Text(
                  locale.guarantee_success_message,
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        KeyValueWidget(
                          ...
                          valueString: controller.promissoryIdController.text,
                        ),
                      ],
                    ),
                  ),
