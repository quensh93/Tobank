...
class PromissorySettlementFinalPage extends StatelessWidget {
  const PromissorySettlementFinalPage({
    super.key,
  });
...
//locale
    ...
    return GetBuilder<PromissorySettlementController>(builder: (controller) {
      return SizedBox(
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        KeyValueWidget(
                          keyString: locale.total_commitment_amount,
