...
class ContinueRequestPromissorySignPage extends StatelessWidget {
  const ContinueRequestPromissorySignPage({super.key});

  @override
  Widget build(BuildContext context) {
//locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<ContinueRequestPromissoryController>(
      builder: (controller) {
        return Padding(
