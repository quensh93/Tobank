...
class PromissoryEndorsementReceiverPage extends StatelessWidget {
  const PromissoryEndorsementReceiverPage({super.key});
              ...
              children: [
                ...
                if (controller.selectedReceiverType == PromissoryCustomerType.individual) ...[
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      filled: false,
                      hintText: locale.national_code_error_reciever,
                      hintStyle: const TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 14.0,
                      ),
                  ...
                  InkWell(
                    ...
                    child: IgnorePointer(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          filled: false,
                          hintText: locale.select_receiver_birthday,
                          hintStyle: const TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 14.0,
                          ),
                          errorText:
                              controller.isBirthdayDateValid ? null : locale.birthday_date_error,
                          border: const OutlineInputBorder(
                            borderSide: BorderSide.none,
                            borderRadius: BorderRadius.all(
                              Radius.circular(10.0),
