...
import '../../../../../controller/authentication/sample/take_personal_photo_sample_controller.dart';
import '../../../../../util/theme/theme_util.dart';
import '../../../../../widget/button/continue_button_widget.dart';
import '../../../../../widget/svg/svg_icon.dart';
import '../../../common/custom_app_bar.dart';

class TakePersonalPhotoSampleScreen extends StatelessWidget {
  const TakePersonalPhotoSampleScreen({required this.returnCallback, required this.userFile, super.key});
...
//locale
    ...
    return GetBuilder<TakePersonalPhotoSampleController>(
      init: TakePersonalPhotoSampleController(userFile: userFile, returnCallback: returnCallback),
      builder: (controller) {
        return PopScope(
          canPop: false,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Image.asset(
                                        'assets/images/personal_picture_frame.png',
                                      ),
                                    ),
                                  ],
                                ),
