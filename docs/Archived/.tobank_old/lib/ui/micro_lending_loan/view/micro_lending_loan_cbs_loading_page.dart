...
class MicroLendingLoanCbsLoadingPage extends StatelessWidget {
  const MicroLendingLoanCbsLoadingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<MicroLendingLoanController>(builder: (controller) {
