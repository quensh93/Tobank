...
class BillIdInquiryBottomSheet extends StatelessWidget {
  const BillIdInquiryBottomSheet({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(locale.bill_payment_title_water_electric, style: ThemeUtil.titleStyle),
                  const SizedBox(
                    height: 24.0,
                  ),
                  Text(
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorText: controller.isBillIdValid ? null :locale.invalid_bill_id,
                      ...
                      suffixIcon: TextFieldClearIconWidget(
                        isVisible: controller.billIdController.text.isNotEmpty,
                        clearFunction: () {
                  ...
                  ContinueButtonWidget(
                    callback: () {
                      controller.validateInvoiceOnlyBillId();
                    },
