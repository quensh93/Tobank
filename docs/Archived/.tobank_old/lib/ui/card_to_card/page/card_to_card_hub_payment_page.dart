...
class CardToCardHubPaymentPage extends StatelessWidget {
  const CardToCardHubPaymentPage({super.key});
          ...
          children: [
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                                ...
                                children: <Widget>[
                                  ...
                                  Flexible(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          controller.destinationCardHolderName ?? '',
                                          textAlign: TextAlign.right,
                                          style: TextStyle(
                                            color: ThemeUtil.textTitleColor,
                                            fontSize: 16,
                      ...
                      TextField(
                        ...
                        controller: controller.shaparakHubCvv2Controller,
                        textAlign: TextAlign.right,
                        ...
                        decoration: InputDecoration(
                          ...
                          errorText: controller.shaparakHubIsCVVValid ? null :locale.enter_cvv2_password,
                          ...
                          suffixIcon: TextFieldClearIconWidget(
                            isVisible: controller.shaparakHubCvv2Controller.text.isNotEmpty,
                            clearFunction: () {
                              controller.shaparakHubCvv2Controller.clear();
                              controller.update();
                            },
                          ),
                        ),
                        ...
                        children: [
                          Expanded(
                            ...
                            child: TextField(
                              ...
                              controller: controller.shaparakHubPasswordController,
                              ...
                              decoration: InputDecoration(
                                ...
                                errorText: controller.shaparakHubIsPasswordValid ? null : locale.enter_validate_password,
                                border: const OutlineInputBorder(
                                  borderSide: BorderSide.none,
                                  borderRadius: BorderRadius.all(
                                    Radius.circular(8.0),
                                ...
                                suffixIcon: TextFieldClearIconWidget(
                                  isVisible: controller.shaparakHubPasswordController.text.isNotEmpty,
                                  clearFunction: () {
                                    controller.shaparakHubPasswordController.clear();
                                    controller.update();
                                  },
                                ),
                              ),
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: OutlinedButton(
                                ...
                                onPressed: () {
                                  controller.requestShaparakHubOtp();
                                },
            ...
            Padding(
              ...
              child: ContinueButtonWidget(
                callback: () {
                  controller.validateShaparakHubSecondPage();
                },
