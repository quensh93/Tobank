...
class CharitySelectPaymentBottomSheet extends StatelessWidget {
  const CharitySelectPaymentBottomSheet({super.key});
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      controller.selectedCharityData!.title ?? '',
                      style: TextStyle(
                    ...
                    Text(
                      controller.selectedCharityData!.instituteName ?? '',
                      style: TextStyle(
                        color: ThemeUtil.textTitleColor,
                        fontWeight: FontWeight.w600,
                        fontSize: 14.0,
