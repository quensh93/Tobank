...
class CardSecondaryPasswordResultPage extends StatelessWidget {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                locale.second_card_code_issued,
                textAlign: TextAlign.center,
                style: TextStyle(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 16.0),
                      DetailItemWidget(
                        value: controller.changeCardPinResponse!.data!.pin2 ?? '',
                        title: locale.second_card_password,
                        showCopyIcon: true,
                        isSecure: true,
