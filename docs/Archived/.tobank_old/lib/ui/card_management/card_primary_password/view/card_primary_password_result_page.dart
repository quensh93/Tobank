...
class CardPrimaryPasswordResultPage extends StatelessWidget {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                locale.card_first_password_issued_successfully,
                textAlign: TextAlign.center,
                style: TextStyle(
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      DetailItemWidget(
                        value: AppUtil.splitCardNumber(controller.customerCard.cardNumber!, ' - '),
                      ...
                      const SizedBox(height: 16.0),
                      DetailItemWidget(
                        value: controller.changeCardPinResponse!.data!.pin1 ?? '',
                        title: locale.card_first_password,
                        showCopyIcon: true,
                        isSecure: true,
                        isShow: controller.showPassword,
                        toggleIsShowFunction: (isChecked) {
                          controller.toggleShowPassword(isChecked);
                        },
