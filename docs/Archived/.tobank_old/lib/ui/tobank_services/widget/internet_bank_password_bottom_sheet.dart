...
class InternetBankPasswordBottomSheet extends GetView<TobankServicesController> {
  const InternetBankPasswordBottomSheet({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              locale.recover_internet_bank_password,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                errorText: controller.isUsernameValid ? null : locale.internet_bank_username_error,
            ...
            Obx(() {
              ...
              return CustomContinueButton(
                callback: () {
                  controller.validatePasswordForm(subsystem: 1);
                },
