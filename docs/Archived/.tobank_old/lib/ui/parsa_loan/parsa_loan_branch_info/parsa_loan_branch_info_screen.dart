...
import 'view/parsa_loan_select_branch_page.dart';

class ParsaLoanBranchInfoScreen extends StatelessWidget {
  const ParsaLoanBranchInfoScreen({required this.trackingNumber, super.key});
...
//locale
    ...
    return GetBuilder<ParsaLoanBranchInfoController>(
      init: ParsaLoanBranchInfoController(trackingNumber: trackingNumber),
      builder: (controller) {
                      ...
                      Expanded(
                        child: PageView(
                          ...
                          children: [
                            ...
                            const ParsaLoanSelectBranchPage(),
                          ],
                        ),
                      ),
                    ],
