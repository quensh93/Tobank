...
class ParsaLoanConfirmationBottomSheet extends StatelessWidget {
  const ParsaLoanConfirmationBottomSheet({super.key});
...
//locale
    ...
    return Directionality(
      ...
      child: GetBuilder<ParsaLoanContractController>(
        builder: (controller) {
          return Padding(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                locale.amount_format(AppUtil.formatMoney(controller.loanDetail!.extra!.approveLoan![0].totalAmount)),
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                controller.loanDetail!.extra!.approveLoan![0].paybackPeriod.toString(),
                                textAlign: TextAlign.left,
                                style: TextStyle(
                                  color: ThemeUtil.textTitleColor,
                                  fontWeight: FontWeight.w600,
