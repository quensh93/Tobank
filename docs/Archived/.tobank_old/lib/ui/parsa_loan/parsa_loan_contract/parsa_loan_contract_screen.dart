...
import 'view/parsa_loan_result_page.dart';
import 'view/parsa_loan_sign_contract_page.dart';

class ParsaLoanContractScreen extends StatelessWidget {
  const ParsaLoanContractScreen({required this.trackingNumber, super.key});
...
//locale
    ...
    return GetBuilder<ParsaLoanContractController>(
      init: ParsaLoanContractController(trackingNumber: trackingNumber),
      builder: (controller) {
                      ...
                      Expanded(
                        child: PageView(
                          ...
                          children: [
                            ...
                            const ParsaLoanSignContractPage(),
