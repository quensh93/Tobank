...
import 'view/parsa_loan_amount_page.dart';

class ParsaLoanAmountScreen extends StatelessWidget {
  const ParsaLoanAmountScreen({required this.trackingNumber, super.key});
...
//locale
    ...
    return GetBuilder<ParsaLoanAmountController>(
      init: ParsaLoanAmountController(trackingNumber: trackingNumber),
      builder: (controller) {
