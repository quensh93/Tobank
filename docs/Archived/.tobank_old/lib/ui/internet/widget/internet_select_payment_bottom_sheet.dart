...
class InternetSelectPaymentBottomSheet extends StatelessWidget {
  const InternetSelectPaymentBottomSheet({super.key});
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        controller.selectedDataPlanList!.title ?? '',
                        style: TextStyle(
                          color: ThemeUtil.textTitleColor,
                          fontWeight: FontWeight.w600,
                          fontSize: 14.0,
                            ...
                            children: [
                              Text(
                                !controller.useDiscount
                                    ? AppUtil.formatMoney(controller.selectedDataPlanList!.priceWithTax)
                                    : AppUtil.formatMoney(
