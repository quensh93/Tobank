...
class GiftCardDesignSelectorPage extends StatelessWidget {
  const GiftCardDesignSelectorPage({super.key});
                    ...
                    children: [
                      if (controller.giftCardSelectedDesignData != null)
                        ClipRRect(
                          borderRadius: const BorderRadius.all(Radius.circular(8)),
                          child: Image.network(
                            AppUtil.baseUrlStatic() + controller.giftCardSelectedDesignData!.selectedPlan!.image!,
