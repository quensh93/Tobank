...
class GiftCardSelectPaymentBottomSheet extends StatelessWidget {
  const GiftCardSelectPaymentBottomSheet({super.key});
                  ...
                  children: [
                    Card(
                      ...
                      child: const Padding(
                        ...
                        child: SvgIcon(SvgIcons.giftCard),
                      ),
                    ),
                    const SizedBox(
                      height: 16.0,
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: [
                            Text(
                              AppUtil.formatMoney(controller.getAllCost()),
                              style: TextStyle(
                                color: ThemeUtil.textTitleColor,
