...
class MobilePasswordConfirmPage extends StatelessWidget {
  const MobilePasswordConfirmPage({
    super.key,
  });
        ...
        return SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  locale.mobile_bank_username_hint,
                  style: TextStyle(
                ...
                ContinueButtonWidget(
                  callback: () {
                    controller.validateFirstPage(subsystem: 4);
                  },
