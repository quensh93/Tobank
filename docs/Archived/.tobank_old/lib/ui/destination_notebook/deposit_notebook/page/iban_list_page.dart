...
class IbanListPage extends StatelessWidget {
  const IbanListPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<IbanNotebookController>(
      builder: (controller) {
        return Container(
          child: controller.notebookIbanDataList.isNotEmpty
              ? Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemCount: controller.notebookIbanDataList.length,
                        itemBuilder: (BuildContext context, int index) {
                          return DepositNotebookItem(
                            depositDataModel: controller.notebookIbanDataList[index],
