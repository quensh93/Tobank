...
class TransferStatusInquiryChequeInfoPage extends StatelessWidget {
  const TransferStatusInquiryChequeInfoPage({super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<TransferStatusController>(
      builder: (controller) {
        return Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                crossAxisAlignment: controller.isIdValid ? CrossAxisAlignment.center : CrossAxisAlignment.start,
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        errorText: controller.isIdValid ? null : locale.saayad_id_error,
