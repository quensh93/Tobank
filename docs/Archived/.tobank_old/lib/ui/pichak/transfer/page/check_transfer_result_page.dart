...
class CheckTransferResultPage extends StatelessWidget {
  final bool transferReversal;
  const CheckTransferResultPage({required this.transferReversal, super.key});
      ...
      return SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              SvgIcon(
                controller.confirmationResponse.data!.status == 1
              ...
              Text(
                transferReversal
                    ?
                controller.confirmationResponse.data!.status == 1 ? locale.cheque_successfully_transferred : locale.unsuccessful
                    :
                controller.confirmationResponse.data!.status == 1 ? locale.cheque_successfully_transferred :locale.unsuccessful,
