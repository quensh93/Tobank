...
class OwnerCreditInquiryChequeInfoPage extends StatelessWidget {
  const OwnerCreditInquiryChequeInfoPage({super.key});

  @override
  Widget build(BuildContext context) {
    //locale
    final locale = AppLocalizations.of(context)!;
    return GetBuilder<OwnerCreditController>(builder: (controller) {
      return Padding(
