                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            children: [
                              Text(
                                controller.mainController.authInfoData!.customerNumber != null
                                    ? locale.complete_authentication_existing_customer
                                    : locale.complete_authentication_new_customer,
                                style: TextStyle(
                              ...
                              if (!controller.mainController.authInfoData!.digitalBankingCustomer!) ...<Widget>[
                                const SizedBox(height: 16.0),
                                Text(
                                  locale.invite_code_optional_prompt,
                                  style: TextStyle(
                                    color: ThemeUtil.textTitleColor,
                                    fontSize: 16,
                                    fontWeight: FontWeight.w500,
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                filled: false,
                                hintText: locale.job_title_error_message,
                                hintStyle: const TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 14.0,
                                ),
                                errorText: controller.isJobDescriptionValid ? null : locale.job_title_error_message,
                      ...
                      if (!controller.mainController.authInfoData!.digitalBankingCustomer!)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            const SizedBox(
