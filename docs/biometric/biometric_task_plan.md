...
- [x] Register the new test widget route in `lib/core/stac/services/widget/stac_widget_loader.dart`, following the same pattern as `authentication_menu`, `promissory_menu`, and `dashboard_menu`.
