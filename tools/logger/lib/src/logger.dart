...
class Logger {
  ...
  /// Maximum length for log messages. 0 means unlimited.
  static int maxLogLength = 0;

  /// Whether to truncate log messages that exceed [maxLogLength].
  ...
  void log(
    ...
    if (truncateLogs &&
        maxLogLength > 0 &&
        message is String &&
        message.length > maxLogLength) {
      processedMessage = '${message.substring(0, maxLogLength)}... (truncated)';
    }
