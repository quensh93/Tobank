# flows/transfer_real/json/transfer_real_in_bank_result.json

Source: lib/stac/tobank/flows/transfer_real/json/transfer_real_in_bank_result.json
                ...
                "children": [
                  {
                    "children": [
                      ...
                      {
                        "data": "Ø¯Ø±Ø®ÙˆØ§Ø³Øª Ø§Ù†ØªÙ‚Ø§Ù„ Ø´Ù…Ø§ Ø¨Ø§ Ù…ÙˆÙÙ‚ÛŒØª Ø«Ø¨Øª Ø´Ø¯.",
                        "style": {
                          "type": "custom",
                          "color": "{{appColors.current.text.title}}",
                          "fontSize": 18.0,
                      ...
                      "children": [
                        ...
                        },
                        {
                          ...
                          "children": [
                            {
                              "child": {
                                "data": "Ø²Ù…Ø§Ù† Ø§Ù†ØªÙ‚Ø§Ù„ ÙˆØ¬Ù‡",
                                "style": {
                                  "type": "custom",
                                  "color": "{{appColors.current.text.subtitle}}",
                                  "fontSize": 17.0,
                            ...
                            },
                            {
                              "child": {
                                "alignment": "centerStart",
                                "child": {
                                  "data": "Û±Û´Û°Ûµ/Û°Û²/Û°Ûµ - Û±Û²:Û²Û¶",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 17.0,
                        ...
                        },
                        {
                          ...
                          "children": [
                            {
                              "child": {
                                "data": "Ø´Ù…Ø§Ø±Ù‡ Ø³Ù¾Ø±Ø¯Ù‡ Ù…Ø¨Ø¯Ø§",
                                "style": {
                                  "type": "custom",
                                  "color": "{{appColors.current.text.subtitle}}",
                                  "fontSize": 17.0,
                        ...
                        },
                        {
                          ...
                          "children": [
                            {
                              "child": {
                                "data": "Ø´Ù…Ø§Ø±Ù‡ Ø³Ù¾Ø±Ø¯Ù‡ Ù…Ù‚ØµØ¯",
                                "style": {
                                  "type": "custom",
                                  "color": "{{appColors.current.text.subtitle}}",
                                  "fontSize": 17.0,
                        ...
                        },
                        {
                          ...
                          "children": [
                            {
                              "child": {
                                "data": "ØµØ§Ø­Ø¨ Ø³Ù¾Ø±Ø¯Ù‡ Ù…Ù‚ØµØ¯",
                                "style": {
                                  "type": "custom",
                                  "color": "{{appColors.current.text.subtitle}}",
                                  "fontSize": 17.0,
                        ...
                        },
                        {
                          ...
                          "children": [
                            {
                              "child": {
                                "data": "Ø´Ù…Ø§Ø±Ù‡ Ù¾ÛŒÚ¯ÛŒØ±ÛŒ Ø¨Ø§Ù†Ú©ÛŒ",
                                "style": {
                                  "type": "custom",
                                  "color": "{{appColors.current.text.subtitle}}",
                                  "fontSize": 17.0,
                            ...
                            },
                            {
                              "child": {
                                "alignment": "centerStart",
                                "child": {
                                  "data": "Û±Û´Û°ÛµÛ°Û²Û°ÛµÛ°Û¶Û´Û³Û°Û°Û³Û¸ÛµÛ²Û±Û·Û±",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 17.0,
