# flows/promissory/json/promissory_intro.json

Source: lib/stac/tobank/flows/promissory/json/promissory_intro.json
...
```json
{
  "appBar": {
    ...
    "title": {
      "data": "{{appStrings.promissory.title}} JSON",
      "style": {
        "type": "alias",
            ...
            "children": [
              {
                ...
                "onTap": {
                  "actionType": "navigate",
                  "assetPath": "lib/stac/tobank/flows/promissory/json/promissory_rules.json",
