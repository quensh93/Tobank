# flows/promissory/json/request_promissory_deposit.json

Source: lib/stac/tobank/flows/promissory/json/request_promissory_deposit.json
      ...
      "children": [
                ...
                },
                {
                  "child": {
                    ...
                    "decoration": {
                      "color": "{{appColors.current.background.surfaceContainer}}",
                      "border": {
                        "color": "{{isDeposit3Selected ? appColors.current.primary.color : appColors.current.input.borderEnabled}}",
                        "width": 1.0
                      },
                      "borderRadius": {
                        "topLeft": 8.0,
                      ...
                      "children": [
                        {
                          ...
                          "children": [
                            ...
                            },
                            {
                              "decoration": {
                                "border": {
                                  "color": "{{isDeposit3Selected ? appColors.current.primary.color : appColors.current.text.subtitle}}",
                                  "width": 2.0
                                },
                                "shape": "circle"
                              },
                              ...
                              "child": {
                                "child": {
                                  "type": "opacity",
                                  "opacity": "{{isDeposit3Selected ? 1.0 : 0.0}}",
                                  "child": {
                                    "decoration": {
                                      "color": "{{appColors.current.primary.color}}",
                                      "shape": "circle"
        ...
        },
        {
          ...
          "child": {
            ...
            "onPressed": {
              "actionType": "navigate",
              "assetPath": "lib/stac/tobank/flows/promissory/json/promissory_issuer.json",
