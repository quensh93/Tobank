# flows/promissory/json/promissory_success.json

Source: lib/stac/tobank/flows/promissory/json/promissory_success.json
...
```json
{
  ...
  "child": {
    "appBar": {
      ...
      "title": {
        "data": "{{appStrings.promissory.successTitle}} JSON",
        "style": {
          "type": "alias",
                    ...
                    "children": [
                      {
                        ...
                        "children": [
                          ...
                          {
                            "child": {
                              "data": "{{transactionAmount}} {{appStrings.common.rial}}",
                              "style": {
                                "type": "custom",
