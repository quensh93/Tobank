# flows/promissory/json/promissory_confirm.json

Source: lib/stac/tobank/flows/promissory/json/promissory_confirm.json
...
```json
{
    "appBar": {
        ...
        "title": {
            "data": "{{appStrings.promissory.confirmTitle}} JSON",
            "style": {
                "type": "alias",
        ...
        "children": [
                                        ...
                                        },
                                        {
                                            ...
                                            "child": {
                                                ...
                                                "children": [
                                                    ...
                                                    {
                                                        "data": "{{form.promissory_amount}} {{appStrings.common.rial}}",
                                                        "style": {
                                                            "type": "custom",
                                                            "color": "{{appColors.current.text.title}}",
                                                            "fontSize": 14.0,
                                        ...
                                        },
                                        {
                                            ...
                                            "child": {
                                                ...
                                                "children": [
                                                    ...
                                                    {
                                                        "data": "{{userData.issuerPhoneNumber}}",
                                                        "style": {
                                                            "type": "custom",
                                                            "color": "{{appColors.current.text.title}}",
                                                            "fontSize": 14.0,
            ...
            },
            {
                ...
                "child": {
                    "onPressed": {
                        "actionType": "navigate",
                        "assetPath": "lib/stac/tobank/flows/promissory/json/promissory_payment.json",
