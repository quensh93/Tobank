# flows/promissory/json/promissory_issuer.json

Source: lib/stac/tobank/flows/promissory/json/promissory_issuer.json
...
```json
{
  ...
  "child": {
    "appBar": {
      ...
      "title": {
        "data": "{{appStrings.promissory.issuerTitle}} JSON",
        "style": {
          "type": "alias",
                  ...
                  "child": {
                    ...
                    "children": [
                      ...
                      },
                      {
                        ...
                        "children": [
                          {
                            "data": "{{appStrings.promissory.depositShaba}}",
                            "style": {
                              "type": "custom",
                              "color": "{{appColors.current.text.subtitle}}",
                              "fontSize": 14.0,
                          ...
                          {
                            "data": "{{form.selected_shaba_number}}",
                            "style": {
                              "type": "custom",
                              "color": "{{appColors.current.text.title}}",
                              "fontSize": 14.0,
          ...
          "child": {
            "onPressed": {
              ...
              "actions": [
                ...
                {
                  "actionType": "navigate",
                  "assetPath": "lib/stac/tobank/flows/promissory/json/promissory_receiver.json",
