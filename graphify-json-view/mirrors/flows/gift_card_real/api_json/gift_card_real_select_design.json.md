# flows/gift_card_real/api_json/gift_card_real_select_design.json

Source: lib/stac/tobank/flows/gift_card_real/api_json/gift_card_real_select_design.json
  ...
  "child": {
    ...
    "body": {
      ...
      "child": {
        ...
        "children": [
          {
            "data": "Ø¯Ø³ØªÙ‡â€ŒØ¨Ù†Ø¯ÛŒ Ú©Ø§Ø±Øª Ù‡Ø¯ÛŒÙ‡ Ø±Ø§ Ø§Ù†ØªØ®Ø§Ø¨ Ú©Ù†ÛŒØ¯",
            "style": {
              "type": "custom",
              "color": "{{appColors.current.text.title}}",
              "fontSize": 18.0,
