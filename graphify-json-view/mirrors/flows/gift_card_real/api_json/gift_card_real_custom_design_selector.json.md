# flows/gift_card_real/api_json/gift_card_real_custom_design_selector.json

Source: lib/stac/tobank/flows/gift_card_real/api_json/gift_card_real_custom_design_selector.json
                ...
                "children": [
                  {
                    ...
                    "child": {
                      "data": "Ù…ØªÙ† Ùˆ ØªØµÙˆÛŒØ± Ø§Ù†ØªØ®Ø§Ø¨ÛŒ Ø®ÙˆØ¯ Ø±Ø§ Ø¨Ø±Ø±Ø³ÛŒ Ùˆ ØªØ§ÛŒÛŒØ¯ Ù†Ù…Ø§ÛŒÛŒØ¯",
                      "style": {
                        "type": "custom",
                        "color": "{{appColors.current.text.title}}",
                        "fontSize": 16.0,
                  ...
                  },
                  {
                    ...
                    "visible": "[[!giftCardRealCustomHasSelection]]",
                    "child": {
                      "data": "Ù…ØªÙ† Ùˆ ØªØµÙˆÛŒØ± Ù…ÙˆØ±Ø¯ Ù†Ø¸Ø± Ø®ÙˆØ¯ Ø±Ø§ Ø§Ù†ØªØ®Ø§Ø¨ Ú©Ù†ÛŒØ¯",
                      "style": {
                        "type": "custom",
                        "color": "{{appColors.current.text.title}}",
                        "fontSize": 16.0,
                      ...
                      "replacement": {
                        ...
                        "children": [
                          ...
                          },
                          {
                            ...
                            "child": {
                              "child": {
                                "data": "ØªØµÙˆÛŒØ± Ù…ÙˆØ±Ø¯ Ù†Ø¸Ø± Ø´Ù…Ø§",
                                "style": {
                                  "type": "custom",
                                  "color": "{{appColors.current.text.title}}",
                                  "fontSize": 19.0,
                          ...
                          },
                          {
                            ...
                            "child": {
                              ...
                              "children": [
                                ...
                                {
                                  "data": "Ù…ØªÙ† Ù…ÙˆØ±Ø¯ Ù†Ø¸Ø± Ø´Ù…Ø§",
                                  "style": {
                                    "type": "custom",
                                    "color": "#000000",
                                    "fontSize": 16.0,
                        ...
                        },
                        {
                          "child": {
                            "children": [
                              ...
                              {
                                "data": "Ø§Ù†ØªØ®Ø§Ø¨ Ù…ØªÙ† Ùˆ ØªØµÙˆÛŒØ±",
                                "style": {
                                  "type": "custom",
                                  "color": "{{appColors.current.text.title}}",
                                  "fontSize": 18.0,
