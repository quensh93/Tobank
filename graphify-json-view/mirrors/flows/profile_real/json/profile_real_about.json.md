# flows/profile_real/json/profile_real_about.json

Source: lib/stac/tobank/flows/profile_real/json/profile_real_about.json
...
```json
{
  "appBar": {
    ...
    "title": {
      "data": "{{appStrings.profile.real.about.title}}",
      "style": {
        "type": "alias",
