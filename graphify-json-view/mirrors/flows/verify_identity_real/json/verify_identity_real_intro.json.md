# flows/verify_identity_real/json/verify_identity_real_intro.json

Source: lib/stac/tobank/flows/verify_identity_real/json/verify_identity_real_intro.json
                        ...
                        },
                        {
                          ...
                          "child": {
                            ...
                            "children": [
                              ...
                              {
                                "child": {
                                  "data": "{{appStrings.authentication.stepUploadNationalCard}}",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 16.0,
                        ...
                        },
                        {
                          ...
                          "child": {
                            ...
                            "children": [
                              ...
                              {
                                "child": {
                                  "data": "{{appStrings.authentication.stepCaptureFacePhoto}}",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 16.0,
                        ...
                        },
                        {
                          ...
                          "child": {
                            ...
                            "children": [
                              ...
                              {
                                "child": {
                                  "data": "{{appStrings.authentication.stepCaptureFaceVideo}}",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 16.0,
                        ...
                        },
                        {
                          ...
                          "child": {
                            ...
                            "children": [
                              ...
                              {
                                "child": {
                                  "data": "{{appStrings.authentication.stepCollectUserSignature}}",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 16.0,
                        ...
                        },
                        {
                          ...
                          "child": {
                            ...
                            "children": [
                              ...
                              {
                                "child": {
                                  "data": "{{appStrings.authentication.stepCollectEnglishInfo}}",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 16.0,
                        ...
                        },
                        {
                          ...
                          "child": {
                            ...
                            "children": [
                              ...
                              {
                                "child": {
                                  "data": "{{appStrings.authentication.stepCollectDigitalSignature}}",
                                  "style": {
                                    "type": "custom",
                                    "color": "{{appColors.current.text.title}}",
                                    "fontSize": 16.0,
                      ...
                      "children": [
                        {
                          ...
                          "child": {
                            ...
                            "child": {
                              ...
                              "inactiveTrackColor": "{{appColors.current.background.surfaceContainerHigh}}",
                            ...
                            "children": [
                              {
                                "onPressed": {
                                  ...
                                  "title": "Ø´Ø±Ø§ÛŒØ· Ùˆ Ù…Ù‚Ø±Ø±Ø§Øª Ø§Ø±Ø§Ø¦Ù‡ Ø®Ø¯Ù…Ø§Øª ØªÙˆØ¨Ø§Ù†Ú©"
                                },
                                "style": {
          ...
          },
          {
            ...
            "child": {
              ...
              "onPressed": {
                ...
                "actionType": "navigate",
                "request": {
                  "url": "http://192.168.179.21:8101/api/configurations/v1.0/configs/resolve/ipaam.builder.form.form.verify_identity_real_preregister/1",
                  "method": "post",
                  "headers": {
