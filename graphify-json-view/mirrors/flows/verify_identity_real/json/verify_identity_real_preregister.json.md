# flows/verify_identity_real/json/verify_identity_real_preregister.json

Source: lib/stac/tobank/flows/verify_identity_real/json/verify_identity_real_preregister.json
        ...
        },
        {
          ...
          "child": {
            "onPressed": {
              ...
              "actionType": "navigate",
              "request": {
                "url": "http://192.168.179.21:8101/api/configurations/v1.0/configs/resolve/ipaam.builder.form.form.verify_identity_real_verify_otp/1",
                "method": "post",
                "headers": {
