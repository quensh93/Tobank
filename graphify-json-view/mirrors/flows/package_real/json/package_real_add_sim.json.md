# flows/package_real/json/package_real_add_sim.json

Source: lib/stac/tobank/flows/package_real/json/package_real_add_sim.json
              ...
              "children": [
                {
                  "child": {
                    ...
                    "child": {
                      ...
                      "children": [
                        {
                          "data": "Ø´Ù…Ø§Ø±Ù‡ Ø³ÛŒÙ… Ú©Ø§Ø±Øª Ø±Ø§ ÙˆØ§Ø±Ø¯ Ú©Ù†ÛŒØ¯",
                          "style": {
                            "type": "custom",
                            "color": "{{appColors.current.text.title}}",
                            "fontSize": 18.0,
