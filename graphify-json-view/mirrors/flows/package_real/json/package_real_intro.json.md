# flows/package_real/json/package_real_intro.json

Source: lib/stac/tobank/flows/package_real/json/package_real_intro.json
                  ...
                  "child": {
                              ...
                              "child": {
                                ...
                                "child": {
                                  ...
                                  "children": [
                                    ...
                                    {
                                      "data": "Ø³ÛŒÙ…â€ŒÚ©Ø§Ø±Øª ØªÚ©Ø±Ø§Ø±ÛŒ Ø§Ø³Øª",
                                      "style": {
                                        "type": "custom",
                                        "color": "{{appColors.current.feedback.error}}",
                                        "fontSize": 15.0,
                    ...
                    "replacement": {
                      "child": {
                        ...
                        "children": [
                          {
                            "src": "assets/icons/ic_charge_empty_list_light.svg",
                            "imageType": "asset",
                            "width": 106.0,
                            "height": 106.0,
                            "fit": "contain",
                          ...
                          {
                            "data": "Ø¨Ø³ØªÙ‡â€ŒÛŒ Ø§ÛŒÙ†ØªØ±Ù†ØªÛŒ Ù†Ø®Ø±ÛŒØ¯Ù‡â€ŒØ§ÛŒØ¯",
                            "style": {
                              "type": "custom",
                              "color": "{{appColors.current.text.title}}",
                              "fontSize": 18.0,
                          ...
                          {
                            "data": "Ø§ÙˆÙ„ÛŒÙ† Ø¨Ø³ØªÙ‡ Ø§ÛŒÙ†ØªØ±Ù†Øª Ø®ÙˆØ¯ Ø±Ø§ Ø¨Ø®Ø±ÛŒØ¯",
                            "style": {
                              "type": "custom",
                              "color": "{{appColors.current.text.subtitle}}",
                              "fontSize": 18.0,
                ...
                "child": {
                  ...
                  "child": {
                    ...
                    "children": [
                      ...
                      {
                        "data": "Ù¾Ø³ Ø§Ø² ØªØ§ÛŒÛŒØ¯ØŒ Ø³ÛŒÙ…â€ŒÚ©Ø§Ø±Øª Ø§Ø² Ù„ÛŒØ³Øª Ø­Ø°Ù Ø®ÙˆØ§Ù‡Ø¯ Ø´Ø¯.",
                        "style": {
                          "type": "custom",
                          "color": "{{appColors.current.text.title}}",
                          "fontSize": 16.0,
