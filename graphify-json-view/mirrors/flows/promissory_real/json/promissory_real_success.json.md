# flows/promissory_real/json/promissory_real_success.json

Source: lib/stac/tobank/flows/promissory_real/json/promissory_real_success.json
                    ...
                    "children": [
                      {
                        ...
                        "children": [
                          {
                            "child": {
                              "data": "{{appStrings.promissory.paidAmount}}",
                              "style": {
                                "type": "custom",
                                "color": "{{appColors.current.text.subtitle}}",
                                "fontSize": 14.0
                          ...
                          {
                            "child": {
                              "data": "{{transactionAmount_formatted}} {{appStrings.common.rial}}",
                              "style": {
                                "type": "custom",
                      ...
                      },
                      {
                        ...
                        "children": [
                          {
                            "child": {
                              "data": "{{appStrings.promissory.transactionType}}",
                              "style": {
                                "type": "custom",
                                "color": "{{appColors.current.text.subtitle}}",
                                "fontSize": 14.0
                      ...
                      },
                      {
                        ...
                        "children": [
                          {
                            "child": {
                              "data": "{{appStrings.promissory.transactionTime}}",
                              "style": {
                                "type": "custom",
                                "color": "{{appColors.current.text.subtitle}}",
                                "fontSize": 14.0
                      ...
                      },
                      {
                        ...
                        "children": [
                          {
                            "child": {
                              "data": "{{appStrings.promissory.paidVia}}",
                              "style": {
                                "type": "custom",
                                "color": "{{appColors.current.text.subtitle}}",
                                "fontSize": 14.0
                      ...
                      },
                      {
                        ...
                        "children": [
                          {
                            "child": {
                              "data": "{{appStrings.promissory.trackingNumber}}",
                              "style": {
                                "type": "custom",
                                "color": "{{appColors.current.text.subtitle}}",
                                "fontSize": 14.0
                            ...
                            "children": [
                              {
                                ...
                                "onTap": {
                                  "assetPath": "lib/stac/tobank/flows/promissory_real/json/promissory_real_preview.json",
