# flows/promissory_real/json/promissory_real_issuer.json

Source: lib/stac/tobank/flows/promissory_real/json/promissory_real_issuer.json
        ...
        "results": [
          {
            ...
            "action": {
              ...
              "actions": [
                {
                  "actionType": "log",
                  "message": "âŒâŒâŒ DEBUG:={{responses.fetchCustomerInfo.data.natinalCode}}"
                },
                {
                  "actionType": "setValue",
                  "values": [
                    {
                      ...
                      "value": "{{responses.fetchCustomerInfo.data.nationalCode}}"
                    },
                    {
                      "key": "userData.contactNumber",
                      "value": "{{responses.fetchCustomerInfo.data.contactNumber}}"
                    },
                    {
                      "key": "userData.mobile",
                      "value": "{{responses.fetchCustomerInfo.data.cellphoneNumber}}"
                    },
                    {
                    ...
                    },
                    {
                      ...
                      "value": "{{responses.fetchCustomerInfo.data.fatherName}}"
                    },
                    {
                      "key": "userData.fullName",
                      "value": "{{responses.fetchCustomerInfo.data.firstName}} {{responses.fetchCustomerInfo.data.lastName}}"
                    },
                    {
        ...
        "body": {
          ...
          "children": [
            ...
            },
            {
              ...
              "child": {
                "onPressed": {
                  "assetPath": "lib/stac/tobank/flows/promissory_real/json/promissory_real_receiver.json",
