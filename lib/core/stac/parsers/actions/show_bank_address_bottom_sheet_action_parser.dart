...
class ShowBankAddressBottomSheetActionModel {
  ...
  factory ShowBankAddressBottomSheetActionModel.fromJson(
    ...
    return ShowBankAddressBottomSheetActionModel(
      ...
      editTitle:
          json['editTitle'] as String? ?? 'ویرایش آدرس ثبت‌شده در بانک',
      postalCodeHint:
...
class ShowBankAddressBottomSheetActionParser
  ...
  FutureOr<void> onCall(
    ...
    final shouldOpenEdit = await _showCustomerAddressBottomSheet(context, model);
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              onChanged: (_) {
                                ...
                                setModalState(() => showValidationError = false);
                              },
  ...
  Color _resolveInputBorderColor(BuildContext context, ColorScheme colorScheme) {
