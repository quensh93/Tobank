...
class FlowNextActionParser extends StacActionParser<StacFlowNextAction> {
  ...
  FutureOr onCall(BuildContext context, StacFlowNextAction model) async {
    ...
    if (!context.mounted) {
      AppLogger.wc(
        LogCategory.navigation,
        '⚠️ FlowNextAction: Context not mounted, skipping...',
      );
      return;
    }
    ...
    if (flowProvider != null) {
      ...
      if (isLastStep) {
        AppLogger.dc(
          LogCategory.navigation,
          '🏁 FlowNextAction: Last step, completing flow...',
        );
        ...
        AppLogger.dc(
          LogCategory.navigation,
          '➡️ FlowNextAction: Advancing to next step...',
        );
        flowProvider.manager.nextStep();
      }
    } else {
      AppLogger.wc(
        LogCategory.navigation,
        '⚠️ FlowNextAction: No FlowProvider found!',
      );
      AppLogger.wc(
        LogCategory.navigation,
        '   Widget type: ${context.widget.runtimeType}',
      );
      ...
      if (model.fallbackAction != null) {
        AppLogger.dc(
          LogCategory.navigation,
          '🔄 FlowNextAction: Using fallback action...',
        );
