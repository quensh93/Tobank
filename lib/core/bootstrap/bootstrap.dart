...
Future<void> bootstrap() async {
  try {
    ...
    // debugPrint override is now handled in main.dart via AppLogger.overrideFlutterDebugPrint()
    // This ensures it captures logs from early initialization steps like custom parser registration.
