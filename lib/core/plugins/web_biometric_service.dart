...
//         final credential =
//             await _createCredential(publicKeyCredentialCreationOptions);
...
//         final isUserCancelled = errorString.contains('notallowederror') ||
...
//   /// This matches mobile behavior where biometric is requested directly without credential check
...
//                   AppUtil.encryptDataWithAES(data: password);
...
//     if (result != null) {
//       _executeWebAuthnCreate(options).then((value) {
...
//       Uint8List challenge, String credentialId) {
//     final completer = Completer<bool>();

//     _executeWebAuthnGet(challenge, credentialId).then((value) {
//       completer.complete(value);
//     }).catchError((e) {
...
//       Uint8List challenge, String credentialId) async {
//     try {
//       final jsPromise = _getCredentialJS(
//         challenge.toJS,
//         credentialId.toJS,
//       );
