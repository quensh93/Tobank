    ...
    body: StacPadding(
      ...
      child: StacColumn(
        ...
        children: [
          ...
          _buildDisabledButton(label: 'بارگذاری از JSON محلی'),
          StacSizedBox(height: 16),
          _buildDisabledButton(label: 'Load From Json Api'),
        ],
      ),
    ),
  );
