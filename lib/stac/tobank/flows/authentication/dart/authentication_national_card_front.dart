...
const _frontHasImageKey = 'authenticationFrontHasImage';

@StacScreen(screenName: 'authentication_national_card_front')
StacWidget authenticationRealNationalCardFront() {
  return StacStatefulWidget(
    onInit: const StacCustomSetValueAction(
      values: [
        {'key': 'authenticationFrontImage', 'value': ''},
              ...
              child: StacColumn(
                ...
                children: [
                  ...
                  StacRawJsonWidget({
                    ...
                    'onPressed': {
                      'actionType': 'navigate',
                      'fileName': 'authentication_national_card_back',
                      'navMode': 'dart',
        ...
        StacPadding(
          ...
          child: StacColumn(
            ...
            children: [
              StacRawJsonWidget({
                'type': 'visibility',
                'visible': '[[!authenticationFrontHasImage]]',
                'child': StacRow(
                  textDirection: StacTextDirection.rtl,
                  children: [
                    StacExpanded(
...
StacWidget _buildSourceOption({
  ...
  return StacGestureDetector(
    onTap: StacFilePickerAction(
      fileType: 'image',
      targetKey: 'authenticationFrontImage',
  ...
  return StacContainer(
    ...
    child: StacClipRRect(
      ...
      child: StacRawJsonWidget({
        ...
        'child': {
          'type': 'image',
          'src': '{{authenticationFrontImage}}',
          'registryKey': 'authenticationFrontImage',
          'fit': 'cover',
          'width': 999999,
          'height': 190,
          'errorBuilder': {
    ...
    child: StacColumn(
      ...
      children: [
        StacContainer(
          ...
          child: StacText(
            data:
                '{{appStrings.authentication.correctNationalCardSampleTitle}}',
            textDirection: StacTextDirection.rtl,
            textAlign: StacTextAlign.center,
            style: StacCustomTextStyle(
              fontSize: 16,
