...
@StacScreen(screenName: 'authentication_verify_otp')
StacWidget authenticationRealVerifyOtp() {
  return StacStatefulWidget(
    onInit: const StacCustomSetValueAction(
      key: 'isAuthenticationOtpValid',
      value: false,
    ),
    child: StacScaffold(
            ...
            children: [
                          ...
                          StacExpanded(
                            child: StacCustomTextFormField(
                              ...
                              onChanged: StacValidateFieldsAction(
                                resultKey: 'isAuthenticationOtpValid',
                                fields: [
                                  {
                                    'id': 'authentication_otp_code',
                                    'rule': r'^\d{5}$',
              ...
              StacPadding(
                ...
                child: StacRawJsonWidget({
                  ...
                  'enabledKey': 'isAuthenticationOtpValid',
                  'enabled': false,
                  ...
                  'onPressed': NavigationAction(
                    fileName: 'authentication_national_card_front',
