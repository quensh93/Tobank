...
@StacScreen(screenName: 'authentication_registration')
StacWidget authenticationRealRegistration() {
        ...
        children: [
          StacExpanded(
            child: StacCustomRegistryReactive(
              registryKey: 'authenticationSelectedJobTitle',
              child: StacText(
                data: '{{authenticationSelectedJobTitle}}',
                textDirection: StacTextDirection.rtl,
                textAlign: StacTextAlign.right,
                style: StacCustomTextStyle(
                  fontSize: 14,
