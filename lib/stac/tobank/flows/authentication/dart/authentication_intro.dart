...
@StacScreen(screenName: 'authentication_intro')
StacWidget authenticationRealIntro() {
  return StacStatefulWidget(
    onInit: const StacCustomSetValueAction(
      key: 'isAuthenticationRulesAccepted',
      value: false,
    ),
    child: StacScaffold(
        ...
        StacContainer(
          ...
          child: StacFittedBox(
            ...
            child: StacCustomReactiveSwitch(
              id: 'authentication_rules_switch',
              valueKey: 'isAuthenticationRulesAccepted',
              initialValue: false,
