...
@StacScreen(screenName: 'dashboard_primary_pin_get')
    ...
    body: StacPadding(
      ...
      child: StacColumn(
        ...
        children: [
          ...
          StacFilledButton(
            onPressed: NavigationAction(fileName: 'dashboard_primary_pin_result', navMode: NavModes.dart, navigationStyle: NavigationStyle.push),
