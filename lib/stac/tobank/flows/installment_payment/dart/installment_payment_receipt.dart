...
@StacScreen(screenName: 'installment_payment_receipt')
StacWidget installmentPaymentReceipt() {
  return StacScaffold(
          ...
          children: [
            StacExpanded(
              child: StacCustomWidget.fromJson({
                ...
                'boundaryKey': 'installmentPaymentReceiptContent',
...
StacWidget _successHeader() {
  return StacColumn(
    children: [
      ...
      StacSizedBox(height: 8),
      StacText(
        data: '{{loanPaymentSheet.receiptMessage}}',
        textDirection: StacTextDirection.rtl,
        textAlign: StacTextAlign.center,
        style: StacTextStyle(
          fontSize: 14,
    ...
    child: StacColumn(
      ...
      children: [
        _receiptDetailRow(
          ...
          value:
              '{{appStrings.generated.installment_payment.installment_payment_receipt.rial}}',
        ),
        _dashedLikeDivider(),
        _receiptDetailRow(
          label:
          ...
          value:
              '{{appStrings.generated.installment_payment.installment_payment_receipt.amount_value}}',
        ),
        _dashedLikeDivider(),
        _receiptDetailRow(
...
StacWidget _receiptActionButton({
  ...
  return StacOutlinedButton(
    onPressed: StacCustomAction.fromJson({
      ...
      'mode': mode,
      'title':
          '{{appStrings.generated.installment_payment.installment_payment_receipt.installment_payment_receipt}}',
      'pixelRatio': 3.0,
      'boundaryKey': 'installmentPaymentReceiptContent',
    }),
