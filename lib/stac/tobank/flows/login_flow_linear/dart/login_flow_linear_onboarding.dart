...
import 'package:tobank_sdui/stac/tobank/flows/login/dart/stac_tobank_onboarding_slider.dart';
...
@StacScreen(screenName: 'login_flow_linear_onboarding')
StacWidget tobankLoginFlowLinearOnboarding() {
  return StacScaffold(
    ...
    body: StacTobankOnboardingSlider(
      ...
      onFinish: {
        'actionType': 'navigate',
        'widgetType': 'login_flow_linear_login',
