...
@StacScreen(screenName: 'transfer_details')
          ...
          child: StacColumn(
            ...
            children: [
              ...
              StacCustomReactiveElevatedButton(
                ...
                onPressed: _showTransferTypeBottomSheetAction(),
...
StacAction _showTransferTypeBottomSheetAction() {
  return StacShowBottomSheetAction(
    title: 'transfer_type',
    backgroundColor: '#8B63708C',
    sheet: _buildTransferTypeBottomSheet().toJson(),
  );
}
...
StacWidget _buildTransferTypeBottomSheet() {
    ...
    child: StacColumn(
      ...
      children: [
        ...
        _transferTypeItem(
          ...
          subtitle:
              '{{appStrings.generated.transfer.transfer_details.account_transfer}}',
        ...
        _transferTypeItem(
          ...
          subtitle:
              '{{appStrings.generated.transfer.transfer_details.rial_transfer_fee}}',
        ...
        _transferTypeItem(
          ...
          subtitle:
              '{{appStrings.generated.transfer.transfer_details.rial_transfer_until_fee}}',
          iconAsset: 'assets/icons/ic_bank_transfer.svg',
          enabled: true,
          onTap: _selectTransferTypeAndContinue(
            '{{appStrings.generated.transaction.transaction_intro.sample_label}}',
        ...
        _transferTypeItem(
          ...
          subtitle:
              '{{appStrings.generated.transfer.transfer_details.amount_rial_transfer_day}}',
