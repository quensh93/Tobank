...
import 'package:tobank_sdui/stac/tobank/flows/internet_pakage/dart/widgets/internet_pakage_widgets.dart';

@StacScreen(screenName: 'internet_pakage_intro')
              ...
              child: StacColumn(
                ...
                children: [
                          ...
                          children: [
                            StacCustomVisibility(
                              ...
                              child: StacPadding(
                                ...
                                child: buildInternetPakageRealDuplicateBanner(),
                              ).toJson(),
                              ...
                              child: StacColumn(
                                ...
                                children: [
                                  _buildSimCard(
                                    ...
                                    selectAction: _openInternetPakageFlow(
                                      index: 1,
                                      number: '{{crSim1Number}}',
                                      operator: '{{crSim1Operator}}',
                                      logo: '{{crSim1Logo}}',
                  ...
                  StacRow(
                    ...
                    children: [
                      buildInternetPakageRealAddButton(
                        routeName: 'internet_pakage_add_sim',
                      ),
                    ],
                  ),
                ],
...
StacWidget _buildSimCard({
  ...
  return StacCustomVisibility(
    ...
    child: StacPadding(
      ...
      child: buildInternetPakageRealSimCardItem(
...
StacAction _openInternetPakageFlow({
  required int index,
