...
@StacScreen(screenName: 'internet_pakage_list')
StacWidget packageRealInternetPakageList() {
...
StacWidget _buildInternetPakageList() {
...
StacWidget _internetPakageItem({
...
StacAction _selectInternetPakage(int index) {
