...
const List<Map<String, String>> _inBankMyAccounts = [
  {
    'number': '۱۱۰.۹۹۹۲.۱۷۹۳۸۵۸.۱',
    'title': 'سپرده سرمایه گذاری کوتاه مدت',
  },
  {
    'number': '۱۱۰.۷۹۱.۱۷۹۳۸۵۸.۱',
    'title': 'حساب قرض الحسنه جاری حقیقی توبانک',
  },
];

const List<Map<String, String>> _inBankOtherAccounts = [
  {
    'number': '۱۱۰.۹۹۹۳.۷۶۳۴۰۵۰.۱',
    'title': 'علیرضا حیدریان',
  },
  {
    'number': '۱۱۰.۹۹۹۲.۱۷۹۴۸۸۵.۱',
    'title': 'مهدی جمشید پور',
  },
];
        ...
        for (var i = 0; i < _cardDestinations.length; i++) ...[
          StacCustomVisibility(
            ...
            child: _cardDestinationItem(
              ...
              iconAsset: _cardDestinations[i]['icon'] ??
...
StacWidget _cardScanButton() {
  return StacOutlinedButton(
    onPressed: StacRawJsonAction({
      ...
      'message': 'اسکن کارت به زودی فعال می‌شود.',
  ...
  return StacSequenceAction(
    actions: [
      ...
      StacRawJsonAction({
        ...
        'cardDisplayValues':
            _cardDestinations.map((e) => e['number'] ?? '').toList(),
