...
@StacScreen(screenName: 'gift_card_custom_select_design')
  ...
  return StacStatefulWidget(
    onInit: const StacSetValueAction(
      values: [
        ...
        {'key': 'giftCardRealCustomReplacementMessageOptionId', 'value': ''},
      ],
    ),
    child: StacScaffold(
          ...
          children: [
            StacContainer(
              ...
              child: StacPadding(
                ...
                child: StacText(
                  data:
                      'لطفا یکی از طرح‌های پیش‌فرض را انتخاب کنید تا در صورت عدم موافقت بانک با عکس دلخواه شما، طرح پیش‌فرض جایگزین آن شود',
...
StacWidget _buildCategoryTile({
  ...
  return StacGestureDetector(
    onTap: _giftCardPlanSelectorBottomSheetAction(
      ...
      nextRouteName: 'gift_card_custom_message',
    ),
    child: StacContainer(
      height: 190,
      decoration: StacBoxDecoration(
