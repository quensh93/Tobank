...
import 'package:tobank_sdui/stac/tobank/flows/charge/dart/widgets/charge_widgets.dart';
import 'package:tobank_sdui/stac_core/navigation/nav_modes.dart';

@StacScreen(screenName: 'charge_intro')
              ...
              child: StacColumn(
                ...
                children: [
                      ...
                      replacement: StacCenter(
                        child: StacColumn(
                          ...
                          children: [
                            ...
                            StacText(
                              data:
                                  '{{appStrings.generated.charge.charge_intro.empty_topup_message}}',
                              textDirection: StacTextDirection.rtl,
                            ...
                            StacText(
                              data:
                                  '{{appStrings.generated.charge.charge_intro.topup}}',
                              textDirection: StacTextDirection.rtl,
                              textAlign: StacTextAlign.center,
                              style: StacCustomTextStyle(
                                fontSize: 18,
                  ...
                  StacRow(
                    ...
                    children: [
                      buildChargeRealAddButton(routeName: 'charge_add_sim'),
                    ],
                  ),
                ],
              ),
